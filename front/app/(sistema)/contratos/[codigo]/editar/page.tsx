...
export default function EditarContrato() {
    ...
    const buscarDados = async () => {
        ...
        const valorContratoBack = await axios.get<Contrato>('http://localhost:8080/contratos/' + codigo);

        if (valorContratoBack.status == 200) {
            setContrato(valorContratoBack.data);
        } else {
    ...
    if (!contrato) return (<div className="p-8"> Carregando Dados ...</div>)
        ...
        <div className="w-full px-6 py-10 md:px-10 md:py-14">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <div className="mt-4">
                        ...
                        <p className="mt-1 text-xs text-stone-500 uppercase tracking-wider">
                            Atualize os dados do contrato no sistema
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white border border-stone-200/60 rounded-3xl p-6 sm:p-8 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.05)]">
                    <ContratoForm contratoExistente={contrato} />
                </div>
